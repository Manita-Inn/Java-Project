...
public class GameOver2 extends JFrame {
    public String username; // Declare a variable to hold the username

    // Constructor for the GameOver2 class
    public GameOver2(String username) { // Constructor accepts a username
        ...
        nextPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new chapter2(username); // Create a new chapter2 instance
                dispose(); // Close the current frame
            }
        });
    ...
    // Main method to launch the GameOver2 frame
    public static void main(String[] args) {
        // Example usage: pass a username to GameOver2
        String username = ""; // Placeholder for the username
        new GameOver2(username); // Create an instance with the username (replace with actual username if needed)
    }
}