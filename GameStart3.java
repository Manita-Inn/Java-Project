...
public class GameStart3 extends JFrame {

    String username; // Variable to hold the username

    // Constructor for the GameStart3 class
    public GameStart3() {
        setTitle("GAME START - CHAPTER 3"); // Set the title of the window
        ...
        chapterPanel.setLayout(null); // Use null layout for the panel
        ...
        JLabel chapterNameLabel = new JLabel("<html><center>Chapter 3: Selection</center></html>");
        ...
        startButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new chapter3(username); // Open the chapter3 quiz window
                dispose(); // Close the current window
            }
        });
