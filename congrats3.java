...
public class congrats3 extends JFrame {
    ...
    public congrats3(String username) {
        ...
        JLabel chapterLabel = new JLabel("CHAPTER 3");
        ...
        Image scaledDogImage = dogImage.getScaledInstance(300, 248, Image.SCALE_SMOOTH); // Scale dog image
        ...
        petLabel.setBounds(200, 215, 350, 290); // Set position and size
    ...
    private void loadImages() {
        try {
            ...
            dogImage = ImageIO.read(new File("C:\\Users\\USER\\IdeaProjects\\Quizz\\src\\images\\funny-orange-welsh-corgi-vector-23984395.png"));
        } catch (IOException e) {
            e.printStackTrace(); // Print stack trace if there's an error loading the image
        }
    }

    // Main method to launch the congrats3 frame
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            congrats3 screen = new congrats3("testUser"); // Create an instance with a test username
