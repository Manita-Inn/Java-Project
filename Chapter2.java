...
public class chapter2 extends JFrame {
    ...
    private String[] questions = {
            ...
            "What is the value of 5 / 2 in Java if both operands are integers?",
            "In Java, which keyword is used to define a constant?",
            "What would the result be of the expression 5.0 / 2 in Java?",
            "Which of the following is an augmented assignment operator?",
            "What is the purpose of the ++ operator in Java?",
            "How is the following value converted: int i = (int)3.9;?",
            "What is the correct syntax for defining a double constant in Java?",
            "In Java, which data type is more accurate for storing decimal values?",
            "What is implicit casting in Java?"
    };

    // 2D array of answer options for each question
    private String[][] optionsForQuestions = {
            {"A. 123area", "B. area1", "C. $area", "D. both B and C"},
            {"A. 2.5", "B. 2", "C. 2.0", "D. None of the above"},
            {"A. constant", "B. const", "C. final", "D. static"},
            {"A. 2", "B. 2.5", "C. 2.0", "D. 3"},
            {"A. ==", "B. ++", "C. +=", "D. //"},
            {"A. To decrement a value by 1", "B. To add two variables", "C. To increment a value by 1", "D. To set a value to zero"},
            {"A. i will hold 3", "B. i will hold 4", "C. i will hold 3.9", "D. The code will cause an error"},
            {"A. final int PI = 3.14;", "B. constant double PI = 3.14159;", "C. final double PI = 3.14159;", "D. const double PI = 3.14159;"},
            {"A. float", "B. int", "C. double", "D. byte"},
            {"A. Manually converting data from one type to another", "B. Automatically converting data from a smaller to a larger data type", "C. Automatically converting data from a larger to a smaller data type", "D. Converting non-numeric data to numeric data"}
    };

    private String[] correctAnswers = {"D", "B", "C", "B", "C", "C", "A", "C", "C", "B"}; // Array of correct answers
    ...
    // Constructor for the chapter2 class
    public chapter2(String username) {
        this.username = username; // Initialize username
        setTitle("Java Quiz - Chapter 2"); // Set the window title
        ...
        nextButton.addActionListener(e -> { // Add action listener for Next button
            ...
            if (currentQuestionIndex < questions.length - 1) {
                ...
                if (score >= 8) {
                    new congrats2(username); // Open the congratulations screen
                } else {
                    new GameOver2(username); // Open the game over screen
                }
    ...
    private void storeProgressInFile(String username, int score) {
        ...
        if (score >= 8) { // Check if the score is sufficient for completion
            ...
            try {
                ...
                String sql = "update users set chapter2_score =? where username = ?"; // SQL query to update score
    ...
    // Main method to launch the chapter2 quiz
    public static void main(String[] args) {
        new chapter2("testUser"); // Create an instance of chapter2 with a test username
    }
    ...
    static class RoundedButton extends JButton {
        ...
        protected void paintComponent(Graphics g) {
            Graphics2D g2 = (Graphics2D) g; // Cast to Graphics2D for advanced control
