...
public class GameOver1 extends JFrame {
    ...
    // Constructor for the GameOver1 class
    public GameOver1(String username) {
        ...
        nextPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new chapter1(username, homePage); // Create a new chapter1 instance
                dispose(); // Close the current frame
            }
        });
    ...
    // Main method to launch the GameOver1 frame
    public static void main(String[] args) {
        new GameOver1("testUser"); // Create an instance with a sample username
    }
}