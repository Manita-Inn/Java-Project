...
public class GameOver4 extends JFrame {
    private String username; // Declare a variable to hold the username

    // Constructor for the GameOver4 class
    public GameOver4(String username) { // Constructor accepts a username
        ...
        nextPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new chapter4(username); // Create a new chapter4 instance
                dispose(); // Close the current frame
            }
        });
    ...
    // Main method to launch the GameOver4 frame
    public static void main(String[] args) {
        // Example usage: pass a username to GameOver4
        new GameOver4(""); // Create an instance with a placeholder username (replace with actual username if needed)
    }
}