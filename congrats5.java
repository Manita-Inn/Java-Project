import javax.imageio.ImageIO;           // Import for loading images
...
public class congrats5 extends JFrame {
    ...
    public congrats5(String username) {
        ...
        congratulationsLabel.setBounds(200, 70, 400, 60); // Set position and size
        ...
        messageLabel.setBounds(200, 125, 400, 30); // Set position and size
        confettiPanel.add(messageLabel); // Add to the confetti panel

        // Create and set up the chapter label
        JLabel chapterLabel = new JLabel("CHAPTER 5");
        ...
        chapterLabel.setBounds(300, 180, 200, 30); // Set position and size
        confettiPanel.add(chapterLabel); // Add to the confetti panel

        // Pet image with high-quality scaling
        Image scaledDogImage = dogImage.getScaledInstance(330, 268, Image.SCALE_SMOOTH); // Scale dog image
        ...
        petLabel.setBounds(200, 190, 350, 290); // Set position and size
        ...
        homeButton.setBounds(325, 490, 150, 50); // Set position and size
    ...
    private void loadImages() {
        try {
            ...
            dogImage = ImageIO.read(new File("C:\\Users\\USER\\IdeaProjects\\Quizz\\src\\images\\kisspng-pembroke-welsh-corgi-puppy-image-corgi-dog-download-free-clipart-with-a-transparent-1713878588640.png"));
        } catch (IOException e) {
            e.printStackTrace(); // Print stack trace if there's an error loading the image
        }
    }

    // Main method to launch the congrats5 frame
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            congrats5 screen = new congrats5("testUser"); // Create an instance with a test username
