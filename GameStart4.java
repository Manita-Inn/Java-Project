...
public class GameStart4 extends JFrame {

    String username; // Variable to hold the username

    // Constructor for the GameStart4 class
    public GameStart4() {
        setTitle("GAME START - CHAPTER 4"); // Set the title of the window
        ...
        JLabel chapterNameLabel = new JLabel("<html><center>Chapter 4: Loops</center></html>");
        ...
        startButton.setBounds(360, 450, 200, 50); // Set position and size for the Start button
        ...
        startButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new chapter4(username); // Open the chapter4 quiz window
                dispose(); // Close the current window
            }
        });
