...
public class congrats4 extends JFrame {
    ...
    // Constructor for the congrats4 class
    public congrats4(String username, HomePage homePage, int score) {
        ...
        JLabel chapterLabel = new JLabel("CHAPTER 4");
        ...
        petLabel.setBounds(200, 230, 350, 290); // Set position and size
    ...
    private void loadImages() {
        try {
            ...
            dogImage = ImageIO.read(new File("C:\\Users\\USER\\IdeaProjects\\Quizz\\src\\images\\db967dab7bc9972d24f0edd0ec6b4e81.png"));
        } catch (IOException e) {
            e.printStackTrace(); // Print stack trace if there's an error loading the image
        }
    }

    // Main method to launch the congrats4 frame
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            congrats4 screen = new congrats4("testUser", new HomePage(), 100); // Create an instance with a test username and score
