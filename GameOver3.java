...
public class GameOver3 extends JFrame {
    private String username; // Declare a variable to hold the username

    // Constructor for the GameOver3 class
    public GameOver3(String username) { // Constructor accepts a username
        ...
        nextPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new chapter3(username); // Create a new chapter3 instance
                dispose(); // Close the current frame
            }
        });
    ...
    // Main method to launch the GameOver3 frame
    public static void main(String[] args) {
        // Example usage: pass a username to GameOver3
        new GameOver3(""); // Create an instance with a placeholder username (replace with actual username if needed)
    }
}