...
public class GameStart2 extends JFrame {
    ...
    // Constructor for the GameStart2 class
    public GameStart2() {
        this.username = username; // Initialize username
        this.homePage = homePage; // Initialize homePage reference
        setTitle("GAME START - CHAPTER 2"); // Set the title of the window
        ...
        RoundedPanel chapterPanel = new RoundedPanel(30); // Set corner radius
        ...
        JLabel chapterNameLabel = new JLabel("<html><center>CHAPTER 2: ELEMENTARY PROGRAMMING</center></html>");
        ...
        homeButton.setBounds(150, 450, 200, 50); // Set position and size of the Home button
        ...
        Image resizedHouseImage = houseIcon.getImage().getScaledInstance(60, 60, Image.SCALE_SMOOTH); // Resize image to 60x60 pixels
        JLabel houseIconLabel = new JLabel(new ImageIcon(resizedHouseImage)); // Create a JLabel to hold the resized image
        houseIconLabel.setBounds(323, 110, 70, 70); // Set bounds for the house icon label
        ...
        startButton.setBounds(360, 450, 200, 50); // Set position and size of the Start button
        ...
        startButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("READ " + username); // Log the username
                new chapter2(username); // Open the chapter2 quiz window
                dispose(); // Close the current window
            }
        });
        ...
        frame.add(imageLabel); // Add the image label to the chapter panel
